...
namespace KrosUlohaJH.Migrations
{
    ...
    [Migration("20250715164834_EditedOddelenia")]
    partial class EditedOddelenia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Divizia", b =>
                {
                    ...
                    b.HasIndex("VeduciRC")
                        .IsUnique()
                        .HasFilter("[VeduciRC] IS NOT NULL");
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Oddelenie", b =>
                {
                    ...
                    b.HasIndex("VeduciOddeleniaRc")
                        .IsUnique()
                        .HasFilter("[VeduciOddeleniaRc] IS NOT NULL");
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Projekt", b =>
                {
                    ...
                    b.HasIndex("VeduciProjektuRC")
                        .IsUnique()
                        .HasFilter("[VeduciProjektuRC] IS NOT NULL");
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Divizia", b =>
                {
                    ...
                    b.HasOne("KrosUlohaJH.Models.Zamestnanec", "Veduci")
                        .WithOne()
                        .HasForeignKey("KrosUlohaJH.Models.Divizia", "VeduciRC");
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Oddelenie", b =>
                {
                    ...
                    b.HasOne("KrosUlohaJH.Models.Zamestnanec", "VeduciOddelenia")
                        .WithOne()
                        .HasForeignKey("KrosUlohaJH.Models.Oddelenie", "VeduciOddeleniaRc");
            ...
            modelBuilder.Entity("KrosUlohaJH.Models.Projekt", b =>
                {
                    ...
                    b.HasOne("KrosUlohaJH.Models.Zamestnanec", "VeduciProjektu")
                        .WithOne()
                        .HasForeignKey("KrosUlohaJH.Models.Projekt", "VeduciProjektuRC");
